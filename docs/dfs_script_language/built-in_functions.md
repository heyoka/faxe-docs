...
| `list_sum(List)` -> number                      | eturns the sum of the elements in List.                                                                                                                                                                            |                                               |
...
| `list_string_concat(List1, List2)` -> list      | Concatenate the string representation of the elements of 2 lists, the resulting list is as long as the shorter of the two lists.                                                                                   | list_of_strings("data.lines")                 |
| `list_string_concat(List1, List2, Sep)` -> list | Concatenate the string representation of the elements of 2 lists, the resulting list is as long as the shorter of the two lists. The given separator string will be place in between each of the pairs of strings. | list_of_strings("data.lines")                 |
